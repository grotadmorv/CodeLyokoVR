 ...
 * Moove block one
 */
AFRAME.registerComponent('mantraTwo', {
    init: function () {
        var el = this.el;

        var mantra = document.getElementById("mantra_two");
        ...
        setTimeout(function(){
            ...
            real_block.setAttribute('id', 'new_manta_two');
            scene.appendChild(real_block);

            setInterval(function(){
                var new_manta_two = document.getElementById("new_manta_two");
                if(new_manta_two !== null){
